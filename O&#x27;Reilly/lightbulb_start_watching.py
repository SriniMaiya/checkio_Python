#!/home/srini/.checkio/checkio_chrome_plugin.py --domain=py run lightbulb-start-watching
...
def sum_light(els: List[datetime], start_watching: Optional[datetime] = None) -> int:
    ...
    return sum([(els[j]- els[j-1]).total_seconds() for j in range(i + (i%2 ==0), len(els), 2)])
