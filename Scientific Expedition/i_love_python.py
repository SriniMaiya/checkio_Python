#!/home/srini/anaconda3/envs/tfgpu/bin/checkio --domain=py run i-love-python
...
def i_love_python():
    ...
    x=  """
        Easy to learn yet hard to masfter. Python is more like a puzzle yet written in a spoken language.
        Love it due to it's huge, evergrowing and creative community, it's ease to apply and simplicity :)
    """
    if x==None:
        return "Can't submit"
    else:
