#!/home/srini/anaconda3/envs/checkio/bin/checkio --domain=py run remove-all-before
...
remove_all_before = lambda items,border: border in items and items[items.index(border):] or items
