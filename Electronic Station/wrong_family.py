#!/home/srini/anaconda3/envs/tfgpu/bin/checkio --domain=py run wrong-family
...
def is_family(tree: list[list[str]]) -> bool:
    ...
    return True if len(tree[0])==1 else True if  all(x in tree[0] for x in tree[1]) else False
