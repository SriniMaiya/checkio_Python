#!/home/srini/anaconda3/envs/tfgpu/bin/checkio --domain=py run boolean-algebra
...
def boolean(x, y, operation):
    if operation == "conjunction":
        ...
        return False if (x==1 and y==0) else True
...
# boolean = lambda x,y,op: {'co': x&y ,'di': x|y , 'im': y if x else 1, 'ex': x^y, 'eq': x==y}[op[:2]] 
